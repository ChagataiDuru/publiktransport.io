...
export const PARAMS = {
  ...
  RUSH_CANDIDATES: 5,
  MAX_DEMAND_MULTIPLIER: 6,

  CIVIC_CONTRACT_FIRST_DELAY: 35,
  CIVIC_CONTRACT_TELEGRAPH: 7,
  CIVIC_CONTRACT_DURATION: 30,
  CIVIC_CONTRACT_COOLDOWN: 20,
  CIVIC_CONTRACT_RESOLVED_DISPLAY: 5,
  CIVIC_CONTRACT_DEMAND_MULTIPLIER: 2,
  CIVIC_CONTRACT_TARGET_GAIN: 0.1,
  CIVIC_CONTRACT_MIN_WIN_GAIN: 0.025,
  CIVIC_CONTRACT_REWARD: 3000,

  RAPID_DISPATCH_EXTRA_TRAINS: 2,
  RAPID_DISPATCH_DURATION: 15,
  RAPID_DISPATCH_COOLDOWN: 40,
  RAPID_DISPATCH_COST: 500,

  DISTRICT_CONTROL_MIN_SHARE: 0.18,
  DISTRICT_CONTROL_MARGIN: 0.08,
  DISTRICT_CONTESTED_MARGIN: 0.08,

  FINAL_MANDATE_START_SECONDS: 60,
  FINAL_MANDATE_TELEGRAPH_SECONDS: 8,
  FINAL_MANDATE_DEMAND_MULTIPLIER: 2.5,

  EXPRESS_MIN_STATIONS: 5,
...
export const PARAM_GROUPS: { label: string; keys: (keyof Params)[] }[] = [
  ...
  { label: 'Capacity', keys: ['TRAIN_CAPACITY', 'CROWD_PENALTY_K', 'STATION_DWELL'] },
  {
    ...
    keys: [
      ...
      'CIVIC_CONTRACT_FIRST_DELAY',
      'CIVIC_CONTRACT_TELEGRAPH',
      'CIVIC_CONTRACT_DURATION',
      'CIVIC_CONTRACT_COOLDOWN',
      'CIVIC_CONTRACT_RESOLVED_DISPLAY',
      'CIVIC_CONTRACT_DEMAND_MULTIPLIER',
      'CIVIC_CONTRACT_TARGET_GAIN',
      'CIVIC_CONTRACT_MIN_WIN_GAIN',
      'CIVIC_CONTRACT_REWARD',
      'FINAL_MANDATE_START_SECONDS',
      'FINAL_MANDATE_TELEGRAPH_SECONDS',
      'FINAL_MANDATE_DEMAND_MULTIPLIER',
    ],
  },
  {
    label: 'Tactics',
    keys: [
      'RAPID_DISPATCH_EXTRA_TRAINS',
      'RAPID_DISPATCH_DURATION',
      'RAPID_DISPATCH_COOLDOWN',
      'RAPID_DISPATCH_COST',
      'DISTRICT_CONTROL_MIN_SHARE',
      'DISTRICT_CONTROL_MARGIN',
      'DISTRICT_CONTESTED_MARGIN',
      'EXPRESS_MIN_STATIONS',
    ],
  },
  {
    label: 'Economy',
